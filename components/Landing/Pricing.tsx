  ...
  const pricing = [
    {
      ...
      daysPerWeek: settings.flexPricing.badge,
      daysPerWeekMobile: settings.flexPricing.badge,
      description: settings.flexPricing.subTitle,
    ...
    },
    {
      ...
      daysPerWeek: settings.partTimePricing.badge,
      daysPerWeekMobile: settings.partTimePricing.badge,
      description: settings.partTimePricing.subTitle,
    ...
    },
    {
      ...
      daysPerWeek: settings.dedicatedPricing.badge,
      daysPerWeekMobile: settings.dedicatedPricing.badge,
      description: settings.dedicatedPricing.subTitle,
